...
public class InteractableCardView extends ViewGroup implements PhysicsAnimator.PhysicsAnimatorListener {
    ...
    public InteractableCardView(Context context) {
        super(context);
        init();
    }

    public InteractableCardView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public InteractableCardView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public InteractableCardView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
...
/*         if (isSwiping || ev.getPointerCount() > 1) {
    ...
    private void handleTouch(MotionEvent event) {
        Log.d("interactableCardView","handleTouch action = " + event.getAction());
    ...
    private ReactRootView getReactRoot() {
        ...
        while (v.getParent() != null) {
            if (v instanceof ReactRootView) {
                Log.d("interactableCardView","has root");
                return (ReactRootView) v;
            }
            v = (View) v.getParent();
        }
        Log.d("interactableCardView","no root");
        return null;
    }
...
//        Log.d("interactableCardView","addTempBounceBehaviorWithBoundaries influenceArea = " + boundaries);
...
//        Log.d("interactableCardView","influenceAreaWithRadius minPoint = " + minPoint + " maxPoint = " + maxPoint);
        return new PhysicsArea(minPoint,maxPoint);
    }
...
//            Log.d("interactableCardView","setGravityPoints strength = " + point.strength);
//            Log.d("interactableCardView","setGravityPoints damping = " + point.damping);
...
//            Log.d("interactableCardView","setFrictionAreas damping = " + point.damping);
